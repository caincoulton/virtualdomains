...
/**
 * Helper for mod_vdlanguages
 *
 * @package     Virtualdomains.site
 * @subpackage  mod_vdlanguages
 * 
 * Essentially a straight copy of the system languages module.  Differences:
 * - MenuId fix for associations (117:118)
 */
        ...
        foreach ($languages as $i => &$language) {
            ...
            if (!\array_key_exists($language->lang_code, $sitelangs)) {
                ...
                if ($multilang) {
                    ...
                    } elseif (isset($associations[$language->lang_code]) && $menu->getItem(explode(':', $associations[$language->lang_code])[0])) { // ItemID is retrieved as "id:alias", but we just need the id
                        $itemid         = explode(':', $associations[$language->lang_code])[0];
